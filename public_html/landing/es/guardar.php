...
$infoengienners=$_POST['infoengineers'];

$query = "insert into formulario (id,nombres,apellidos,email,telefono,company,companydireccion,infovendors,infoengineers) values ('','$nombre','$lastname','$email','$phone','$company','$companyaddress','$infovendors','$infoengienners');";
$result = mysqli_query($conn, $query);


$motivo = 'Confirmación de registro';
$num = md5(time());
...
$exito = mail('synnexwestcon@attachamericas.com', 'Confirmación de registro', $mensaje, $headers);




header('Location: https://attachamericas.site/landing/es/');
die()
